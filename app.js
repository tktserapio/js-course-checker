  ...
  try {
    ...
    for (let c of courses) {
      ...
      if (code === course) {
        ...
        // Wait for the sections area to appear
        await driver.wait(
          until.elementLocated(
            By.xpath('//a[@class="course-section course-section--matched"]')
          ),
          10000
        );

        // Now grab matched sections
        const matchedSections = await driver.findElements(
          By.xpath('//a[@class="course-section course-section--matched"]')
        );
